...
class SensorSuite:
    ...
    def __init__(self):
        ...
        # Restore required attributes for test compatibility
        self._cached_temps = {
            "boiler_temp": 25.0,
            "super_temp": 25.0,
            "logic_temp": 25.0
    ...
    def update_encoder(self):
        if hasattr(self, 'speed_sensor') and self.speed_sensor is not None:
            return self.speed_sensor.update_encoder()
        return 0
    ...
    def _init_degradation_state(self):
        self._cached_temps = {
            "boiler_temp": 25.0,
            "super_temp": 25.0,
            "logic_temp": 25.0
    ...
    # Remove unused legacy/test compatibility methods for clarity and to resolve lint errors
